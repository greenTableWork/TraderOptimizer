...
- Output directory: `/Users/vrajpandya/.openclaw/workspace/Trader/TraderOptimizer/runs/regime_tuning_smoke/concurrent_20260601`
...
| `pivot001_pivot_levels_aapl_postgres` | `TechnicalSignal` | `PIVOT-001` | AAPL | AAPL: 10 secs TRADES rth=1 | orderQuantity | direction, volatility, indexFuturesDirection, optionsProbabilityMap3d, tradeVolumeOrderbook | up / long_flat_breakout / slope 3 |
